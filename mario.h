...
public:
	...
	void killEnemy(GameRenderer& renderer, GameActions& game, GameConfig& currBoard, Mario& mario, std::vector<Ghost*>& ghosts, std::vector<Barrel>& barrels, bool& flag, bool& mariowin, bool& ifcolorMode, Results& results, Steps& steps, bool& saveMode); //kill barrel or ghost with hammer
	...
	void deleteKilledEnemy(GameActions& game, GameRenderer& renderer, GameConfig& currBoard, Point killPos, std::vector<Ghost*>& ghosts, std::vector<Barrel>& barrels, bool& flag, bool& mariowin,bool& ifcolorMode, Results& results, Steps& steps, bool& saveMode); //deletesghosts andbarrels that were killed
