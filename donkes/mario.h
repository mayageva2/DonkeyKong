...
public:
	...
	void killEnemy(GameRenderer& renderer, GameActions& game, size_t& counter, GameConfig& currBoard, Mario& mario, vector<Ghost*>& ghosts, vector<Barrel>& barrels, bool& flag, bool& mariowin, bool& ifcolorMode, Results& results, Steps& steps, bool& saveMode); //kill barrel or ghost with hammer
	...
	void deleteKilledEnemy(GameActions& game, GameRenderer& renderer, size_t& counter, GameConfig& currBoard, Point killPos, vector<Ghost*>& ghosts, vector<Barrel>& barrels, bool& flag, bool& mariowin,bool& ifcolorMode, Results& results, Steps& steps, bool& saveMode); //deletesghosts andbarrels that were killed
