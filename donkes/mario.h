...
public:
	...
	void move(GameActions& game, GameRenderer& renderer, GameConfig::eKeys key, GameConfig& currBoard, int& moveCounter, bool& flag, bool& mariowin, vector<Ghost*>& ghosts, vector<Barrel>& barrels,bool& ifcolorMode, Results& results, Steps& steps, size_t& counter, bool& saveMode); //move mario accoring to key pressed
	...
	void left(GameRenderer& renderer, GameConfig& currBoard, int& moveCounter, bool& flag, bool& mariowin,bool& ifcolorMode, Results& results, size_t& counter);    //moves mario left
	void right(GameRenderer& renderer, GameConfig& currBoard, int& moveCounter, bool& flag, bool& mariowin, bool& ifcolorMode, Results& results, size_t& counter);   //moves mario right
	...
	void killEnemy(GameRenderer& renderer, GameActions& game, GameConfig& currBoard, Mario& mario, vector<Ghost*>& ghosts, vector<Barrel>& barrels, bool& flag, bool& mariowin, bool& ifcolorMode, Results& results, Steps& steps, bool& saveMode); //kill barrel or ghost with hammer
	...
	void didMarioWin(GameRenderer& renderer, GameConfig& currBoard, bool& flag, bool& mariowin, bool& ifcolorMode, Results& results, size_t& counter);  //checks if mario reached pauline
	...
	void deleteKilledEnemy(GameActions& game, GameRenderer& renderer, GameConfig& currBoard, Point killPos, vector<Ghost*>& ghosts, vector<Barrel>& barrels, bool& flag, bool& mariowin,bool& ifcolorMode, Results& results, Steps& steps, bool& saveMode); //deletesghosts andbarrels that were killed
