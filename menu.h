...
public:
	...
	const char* instructions[MENU_Y] = {
		// 012345678901a2345678901234567890123456789012345678901234567890123456789012345
		  ...
		  "| In order to PAUSE the game press ESC, Press any key to return to menu.    |",//7
		  "|                                                                           |",//8
		  "| Climb ladders and dodge barrels in order to reach Pauline($), and         |",//9
		  "| win the game!                                                             |",//10
		  "|                                                                           |",//11
		  "| Be Careful!                                                               |",//12
		  "| falling 5 rows or hitting a barrel will cost you a heart,                 |",//13
		  "| losing all 3 hearts ,and the game will end!                               |",//14
		  "|                                                           GOOD LUCK MARIO!|",//15
		  "|---------------------------------------------------------------------------|",//16
	};
	...
	void printScreen(const char** print);
	void displayMenu(Mario& mario);
	void displayEnd_Game(Mario& mario);
	void displayPauseScreen(GameConfig& board,Mario& m);
};
#endif