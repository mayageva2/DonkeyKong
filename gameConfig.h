...
#include <iostream>
#include <string>
static constexpr char ladderCh = 'H';
static constexpr char deleteCh = ' ';
static const std::string EXPLOSION = "BOOM";
...
public:
	...
	enum class eKeys { LEFT = 'a', LEFT2 = 'A', LEFT3 = 'ù', RIGHT = 'd', RIGHT2 = 'D', RIGHT3 = 'â', UP = 'w', UP2 = 'W', UP3 = '\'', DOWN = 'x', DOWN2 = 'X', DOWN3 = 'ñ', STAY = 's', STAY2 = 'S', STAY3 = 'ã', ESC = 27 };
	void PrintBoard();
	void resetBoard();
