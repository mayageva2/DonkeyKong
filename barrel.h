...
public:
	...
	void clearFromScreen(GameActions& game, GameRenderer& renderer, size_t& counter, GameConfig& board, Mario& mario, bool& flag, bool& mariowin, bool& marioKilled,bool& ifcolorMode, Steps& steps, Results& results, bool& saveMode); // Clears the barrel from the screen and updates the game board
	...
	static void barrelsMovement(GameActions& game, GameRenderer& renderer, size_t& counter, std::vector<Barrel>& barrels, GameConfig& board, int& interval, Mario& mario, bool& flag, bool& mariowin, bool& ifcolorMode, Steps& steps, Results& results, bool& saveMode); //moves each barrel
};
