...
void GameWithKeys::setCharCheck(Point& p, GameConfig& currBoard, char object, Mario& mario, bool& flag, bool& mariowin,bool& ifcolorMode) // checks if theres a ladder or floor and then goes to set char on board
{
